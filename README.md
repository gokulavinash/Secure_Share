...
**Other:** Cloudinary, Multer, JWT, Crypto
...
2. Generates a personal encryption key
3. File is encrypted before upload
4. Stored securely in cloud
5. Recipient requests download
6. Admin approves
7. File is decrypted during download
